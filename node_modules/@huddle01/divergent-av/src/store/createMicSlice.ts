import { IMic, IMediErrorType, StoreSlice } from "./storeTypes";

const createMicSlice: StoreSlice<IMic> = (set, get) => ({
  micState: {
  ...
  switchAudioStream: (stream: MediaStream | undefined) => {
    console.info({
      type: "info",
  ...
  setAudioStream: (stream: MediaStream | undefined) => {
    console.info({
      type: "info",
  ...
  pauseAudioTracks: () => {
    ...
    set(() => ({ micState: { ...get().micState, stream: undefined } }));
  },
