...
declare type IErrorType$1 = "userNotFound" | "conversationNotFound" | "sendError" | "deleteError" | "callError" | "noLens" | "groupError" | "signRejected" | null;
...
declare const useDivergentStore: zustand.UseBoundStore<Omit<zustand.StoreApi<{
    errorType: IErrorType$1;
    errorMessage?: string | undefined;
    setError: (type: IErrorType$1, msg: string) => void;
    resetError: () => void;
    user: IUserInfo$1;
    connection: any;
    peer: any;
...
declare class DivergentAVClient extends DivergentSocketClient {
    private secretKey;
...
declare const DivergentAVClientProvider: FunctionComponent<{
    children: React.ReactNode;
    value: DivergentAVClient;
}>;

declare const useDivergentAVClient: () => DivergentAVClient;

declare const createDivergentAVClient: (rpcEndpoint: string) => DivergentAVClient;
declare const getDivergentAVClient: (rpcEndpoint?: string) => DivergentAVClient;

export { DivergentAVClientProvider, createDivergentAVClient, getDivergentAVClient, useDivergentAVClient, useDivergentStore };
